...
if tonumber(plane_id) == nil then
  return 'Plane ID is not a number. Please input correct Plane ID number.'
end

if tonumber(plane_id) < 1 or tonumber(plane_id) > 80 then
  return 'Plane ID is not in between values of 1 and 80. Please input correct plane ID number.'
end
